...
2. Copt the "Falsk server" directory.
...
Starting the camera:  
1. Get a Raspberry Pi or a old device with a camera.
2. A substantial amount of confuguration has to happen to access the headless OS and the camera. 
3. Install Python and all camera code requirments.
