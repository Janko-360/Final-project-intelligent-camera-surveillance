...
# Latest code
# Works, on 32Bit Pi OS 
# Works in general
# There are minor differences to the experimental code that was developed on the computer. 
